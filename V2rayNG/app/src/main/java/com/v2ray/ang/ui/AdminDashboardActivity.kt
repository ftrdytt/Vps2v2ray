...
class AdminDashboardActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // الأزرار للتبديل بين الصفحات (سنركز اليوم على الأول فقط)
        ...
        val layoutActive = findViewById<View>(R.id.layout_active_container)
        val layoutStats = findViewById<View>(R.id.layout_stats_container)

        tabAllUsers.setOnClickListener {
            layoutAll.visibility = View.VISIBLE; layoutActive.visibility = View.GONE; layoutStats.visibility = View.GONE
        ...
        tabActive.setOnClickListener {
            layoutAll.visibility = View.GONE; layoutActive.visibility = View.VISIBLE; layoutStats.visibility = View.GONE
        ...
        tabStats.setOnClickListener {
            layoutAll.visibility = View.GONE; layoutActive.visibility = View.GONE; layoutStats.visibility = View.VISIBLE
            tabStats.setBackgroundColor(Color.parseColor("#FF9800")); tabStats.setTextColor(Color.WHITE)
            tabAllUsers.setBackgroundColor(Color.parseColor("#252529")); tabAllUsers.setTextColor(Color.parseColor("#80FFFFFF"))
            tabActive.setBackgroundColor(Color.parseColor("#252529")); tabActive.setTextColor(Color.parseColor("#80FFFFFF"))
        }

        // جلب المستخدمين عند فتح الشاشة
        fetchAllUsers()
    }
    ...
    private fun addUserCard(id: String, name: String, pass: String, pfp: String, isBanned: Boolean) {
